...
public class CabeceraCatalogoReporteDAOImpl implements CabeceraCatalogoReporteDAO, Serializable {
    ...
    @Override
    public CabeceraCatalogoReporte getCabeceraCatalogoReportesByCodigo(String codigo) {
        CabeceraCatalogoReporte cabeceraCatalogoReporte = (CabeceraCatalogoReporte) sessionFactory.getCurrentSession().createQuery("from CabeceraCatalogoReporte WHERE codigo='" + codigo + "'").uniqueResult();
        return cabeceraCatalogoReporte != null ? cabeceraCatalogoReporte : null;
    }
