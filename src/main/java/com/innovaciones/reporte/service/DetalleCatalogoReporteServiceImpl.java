...
public class DetalleCatalogoReporteServiceImpl extends Utilities implements DetalleCatalogoReporteService, Serializable {
    ...
    public DetalleCatalogoReporte addDetalleCatalogoReporte(DetalleCatalogoReporte detalleCatalogoReporte) {
        return detalleCatalogoReporteDAO.addDetalleCatalogoReporte(detalleCatalogoReporte);
    }
    ...
    public List<DetalleCatalogoReporte> getDetalleCatalogoReporteByIdCategoria(Integer idCategoria, Integer estado) {
        return detalleCatalogoReporteDAO.getDetalleCatalogoReporteByIdCategoria(idCategoria, estado);
    }

    @Override
    @Transactional
    public DetalleCatalogoReporte getDetalleCatalogoReporteByDescripcionByIdCategoria(String descripcion, Integer idCategoria) {
        return detalleCatalogoReporteDAO.getDetalleCatalogoReporteByDescripcionByIdCategoria(descripcion, idCategoria);
    }
