...
public class DetalleReporteInstalacionNuevaServiceImpl implements DetalleReporteInstalacionNuevaService, Serializable {
    ...
    @Override
    @Transactional
    public DetalleReporteInstalacionNueva update(DetalleReporteInstalacionNueva detalleReporteInstalacionNueva) {
        return detalleReporteInstalacionNuevaDAO.update(detalleReporteInstalacionNueva);
    }
