...
public class Configuracion implements Serializable, Cloneable {
    ...
    @Column(name = "email_facturacion", nullable = false, length = 150)
    private String emailFacturacion;

    @Column(name = "email_soporte", length = 150)
    ...
    @Lob
    @Column(name = "logo", columnDefinition = "LONGVARBINARY")
    private byte[] logo;
    ...
    @Column(name = "content_type_archivo", nullable = false, length = 40)
    private String contentTypeArchivo;

    @Column(name = "path_archivo", nullable = false, length = 1000)
    ...
    public String getContentTypeArchivo() {
        return contentTypeArchivo;
    }

    public void setContentTypeArchivo(String contentTypeArchivo) {
        this.contentTypeArchivo = contentTypeArchivo;
    }
